...
/**
 * Esta clase sirve para poder generar un Nodo, el cual es indispensable para
 * poder trabajar en una Lista Simple.
 * 
 * @author Julio Cesar Morales sierra
 * @version 15/10/2019/0.2
 * @param <T> Sirve para que sea una lista de tipo genérica, es decir, que el
...
public class Nodo<T> {
	...
	/**
	 * En el constructor se indica que los Nodos tienen dos atributos, los cuales
	 * son: dato y siguiente.
	 * 
	 * @param dato: Este es un dato de tipo generico, es decir, el usuario puede
	 *              definir de que tipo de dato es posteriormente.
	 */
	public Nodo(T dato) {
		super();
		this.dato = dato;
	...
	/**
	 * Metodo de tipo boolean comparar menor sirve para comparar distintos tipos de
	 * datos, como los integer,float, doubble cuando se nos presente un signos de
	 * comparacion.
	 * 
	 ...
	 * 
	 * @return Retorna un Nodo, el cual es un objeto, donde se guardan
	 ...
	 * 
	 * @param siguiente: Este es un dato de tipo generico, es decir, el usuario
	 *                   puede definir de que tipo de dato es posteriormente.
	 */
