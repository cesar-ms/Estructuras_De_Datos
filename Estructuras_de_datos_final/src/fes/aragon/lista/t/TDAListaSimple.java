...
/**
 * Las listas enlazadas genericas son un tipo de estructura de datos similar a
 * los arrays con la diferencia de que por defecto no tenemos por qué saber la
 * cantidad de elementos que va a contener. Estas listas se componen de nodos
 * los cuales tienen dos atributos: el primero es el item o elemento que va a
 * contener este nodo y el segundo atributo es una referencia al siguiente
...
public class TDAListaSimple<T> {
	...
	/**
	 * Se crea el método insertar cola para ir insertando un elemento detrás del
	 * otro en la lista.
	 * 
	...
	/**
	 * Se crea el método de insertar cabeza para agregar un elemento al inicio de la
	 * lista.
	 * 
	...
	/**
	 * Método de tipo void mostrarDatos() que muestre la lista creada o que se está
	 * creando.
	 * 
	 */
	 ...
	 * 
	 * @param indice que recibe como parámetro un número de tipo entero y elimina el
	 *               dato que está en esa posición o índice.
	 */
	...
	/**
	 * Se crea el método de tipo (T) generico eliminarCabeza que elimina el dato que
	...
	/**
	 * Se crea el método de tipo (T) generico eliminarCola que elimina el dato que
	 * está en la cola de la lista retorna el dato que se está eliminando.
	 * 
	 * 
	 */
	 ...
	 * 
	 * @param dato recibe un dato de tipo genérico (T dato) elimina el dato que se
	 *             le envía
	 * 
	 * @return boolean (la elmiminacion del dato).
	 */
	 ...
	 * 
	 * @param indice que recibe el índice de tipo entero de la posición del nodo que
	 *               se desea obtener
	 * @return retorna el nodo cuando se haya encontrado, si eso no pasa
	 *         retorna(Null = nada) que no se encontró el nodo
	 */
